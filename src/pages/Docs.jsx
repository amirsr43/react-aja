      ...
      <div className="docs-page-layout">
        <div className="docs-container">
          ...
          <main className="docs-main-content">
            ...
            ) : activeId === "infinite-image-marquee" ? (
              <InfiniteImageMarqueeCustomizer />
            ) : activeId === "flicker-text" ? (
              <FlickerTextCustomizer />
            ) : activeId === "testimonial-marquee" ? (
              <TestimonialMarqueeCustomizer />
            ) : currentDoc.variants ? (
